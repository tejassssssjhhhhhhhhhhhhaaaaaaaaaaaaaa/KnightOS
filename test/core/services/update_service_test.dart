...
void main() {
  group('GitHubReleaseUpdateProvider', () {
    test('compares semantic versions numerically and ignores v/build metadata', () {
      final provider = GitHubReleaseUpdateProvider(owner: 'owner', repo: 'repo');
    ...
    test('compares the installed app version with the v2.0.0 release correctly', () {
      final provider = GitHubReleaseUpdateProvider(owner: 'owner', repo: 'repo');
    ...
    test('treats higher build metadata as newer when the semantic version is equal', () {
      final provider = GitHubReleaseUpdateProvider(owner: 'owner', repo: 'repo');
