...
void main() {
  ...
  group('LocalDatabase', () {
    test(
      'uses a platform app data directory instead of the working directory',
      () async {
        ...
        final isInAppDataDirectory =
            file.path.startsWith(supportDirectory.path) ||
            file.path.startsWith(documentsDirectory.path);

        expect(
          isInAppDataDirectory,
          isTrue,
          reason:
              'Storage should target an app data directory, not the current working directory.',
        );
