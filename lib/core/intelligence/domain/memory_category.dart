...
enum BookCategory {
  ...
  static BookCategory fromId(int id) {
    // Constitutional Mapping (Reconciled from 14 implementation categories back to 11)
    if (id == 12) return BookCategory.social;    // Communication -> Social
    if (id == 13) return BookCategory.ambitions; // Upcoming -> Ambitions
    if (id == 14) return BookCategory.skills;    // Knowledge -> Skills
