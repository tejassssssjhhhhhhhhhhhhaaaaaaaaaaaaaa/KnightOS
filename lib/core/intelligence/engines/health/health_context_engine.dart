...
class HealthContextEngine {
  ...
  Future<Set<HealthState>> determineCurrentStates() async {
    ...
    final exercise = recentExercise.firstOrNull?.toExerciseRecord();
    ...
    final latestSymptom = recentSymptoms.firstOrNull?.toSymptomRecord();
    ...
    final hydration = todayHydration.firstOrNull?.toHydrationRecord();
