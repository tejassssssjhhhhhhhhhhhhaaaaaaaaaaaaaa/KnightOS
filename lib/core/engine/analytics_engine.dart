...
class AnalyticsEngine implements KnightModule, KnightAnalyticsStore {
  ...
  List<KnightAnalyticsProvider> get providers => List<KnightAnalyticsProvider>.unmodifiable(_providers);

  /// Returns the current analytics snapshots.
  List<KnightAnalyticsSnapshot> get snapshots => List<KnightAnalyticsSnapshot>.unmodifiable(_snapshots);
